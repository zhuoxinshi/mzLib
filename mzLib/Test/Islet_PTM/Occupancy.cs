...
namespace Test.Islet_PTM
{
    ...
    public class PtmSiteGroup
    {
        ...
        public static void Occupancy()
        {
            ...
            var allPsms = allPSMsTMT_file.Results.Where(p => p.QValue <= 0.01 && p.DecoyContamTarget == "T");
            ...
            var allPeptides = allPeptidesTMT_file.Results.Where(p => p.QValue <= 0.01 && p.DecoyContamTarget == "T");
